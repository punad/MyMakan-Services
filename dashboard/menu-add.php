								...
								<section class="panel">
									<header class="panel-heading">
										...
										<p class="panel-subtitle">
											Untuk menambah menu sila isi maklumat menu dibawah.
										</p>
									</header>
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<select data-plugin-selectTwo class="form-control populate" name="food_type" required="">
														...
														<option value="Fast Food">Makanan</option>
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Muatnaik Gambar</label>
									...
									<footer class="panel-footer">
										<input type="submit" name="addItem" class="btn btn-primary" value="Tambah Menu">
									</footer>
								</section>
							</form>	
						</div>
