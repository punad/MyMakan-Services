      ...
      <div class="container">
        <div class="row no-gutters justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2>Pilih Tarikh dan Masa Untuk Tempahan</h2>
          </div>
        </div>
        <div class="row d-flex">
          <div class="col-md-4 ftco-animate img" style="background-image: url(images/logo.jpg);"></div>
              ...
              <div class="row">
                ...
                <div class="col-md-12 mt-3">
                  <div class="form-group">
                    ...
                    <input type="submit" name="reservation" value="Tempah" class="btn btn-primary py-3 px-5">
                  </div>
                </div>
              </div>
            </form>
