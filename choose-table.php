      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2>Pilih Meja Untuk Anda Menjamu Selera di Restoran</h2>
          </div>
        </div>
                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                  <div class="row">
                      ...
                      <div class="col-lg-3" style="min-height: 190px">
                        <p style="font-weight: bold; padding: ">Meja <?php echo @$i += 1 ?></p>
                        <nav class="menu2">
                      ...
                      <div class="col-lg-12" style="margin-top: 15%;text-align: center;">
                        <div class="form-group">
                          ...
                          <input type="submit" value="Tempah" name="selectChair" class="btn btn-primary py-3 px-5" >
                        </p>
                        </div>
                      </div>
                </div>
