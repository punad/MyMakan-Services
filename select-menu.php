      ...
      <div class="container">
        ...
        <div class="col-md-8 dish-menu">
            ...
            <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link py-3 px-4" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><span class="flaticon-cutlery"></span> Pencuci Mulut</a>
                    ...
                    <div class="menus d-flex ftco-animate">
                      ...
                      <div class="text d-flex">
                        ...
                        <div class="one-forth" style="text-align: center;">
                          <span class="price">RM<?php echo $r['price']; ?></span><br>
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="menus d-flex ftco-animate">
                      ...
                      <div class="text d-flex">
                        ...
                        <div class="one-forth">
                          <span class="price">RM<?php echo $r2['price']; ?></span><br>
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="menus d-flex ftco-animate">
                      ...
                      <div class="text d-flex">
                        ...
                        <div class="one-forth">
                          <span class="price">RM<?php echo $r3['price']; ?></span><br>
          ...
          <div class="col-md-4">
                ...
                <div class="row d-block flex-row">
                  ...
                  <div class="col mb-2 d-flex py-4 border" style="background: white;">
                    <div class="align-self-center">
                      ...
                      <p class="mb-0"><span>No.Kerusi:</span>
            ...
            <div class="col-lg-12" style="text-align: center;">
                ...
                <?php } ?>
                <p style="display: none" id="confirm"><input type="submit" value="Mengesahkan" name="confirm" class="btn btn-primary py-3 px-5" ></p>
